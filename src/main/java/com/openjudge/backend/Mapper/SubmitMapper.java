...
public interface SubmitMapper {
    ...
    @Select("SELECT RID, USERNAME, LANGUAGE, STATUS, RUN_TIME, RUN_MEMORY, GMT_CREATED FROM SUBMIT, USER WHERE SUBMIT.UID = USER.ID AND SUBMIT. PID = #{pid} ORDER BY RID DESC LIMIT #{offset}, #{size}")
